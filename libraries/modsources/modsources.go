...
var Basemods = TwoDText{
  ...
  []string{"https://beta.kerbalstuff.com/mod/139/Aerojet%20Kerbodyne/download/3.0.5", "AerojetKerbodyne.zip"},                                                     //KSP v1.0.x
}
...
var Devmods = TwoDText{
  ...
  []string{"http://addons-origin.cursecdn.com/files/2245/125/Kronal-VV-0.0.4.(1.0.4).zip", "KronalVV.zip"},                                                      //KSP v1.0.4
